...
const ONE_SPLIT_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.ROPSTEN]: '0x50FDA034C0Ce7a8f7EFDAebDA7Aa7cA21CC1267e',
  [ChainId.RINKEBY]: '0x50FDA034C0Ce7a8f7EFDAebDA7Aa7cA21CC1267e',
  [ChainId.GÖRLI]: '0x50FDA034C0Ce7a8f7EFDAebDA7Aa7cA21CC1267e',
  [ChainId.KOVAN]: '0x50FDA034C0Ce7a8f7EFDAebDA7Aa7cA21CC1267e',
};
