...
export const MAX_SIGNIFICANT_DECIMALS = 36;
...
export const ESW: ChainTokenList = {
  [ChainId.MAINNET]: [
    new Token(ChainId.MAINNET, process.env.REACT_APP_ESW_ID, 18, 'ESWc', 'EmiDAO Token'),
  ],
  [ChainId.ROPSTEN]: [
    new Token(ChainId.ROPSTEN, process.env.REACT_APP_ESW_ID, 18, 'ESWc', 'EmiDAO Token'),
  ],
  [ChainId.RINKEBY]: [
    new Token(ChainId.RINKEBY, process.env.REACT_APP_ESW_ID, 18, 'ESWc', 'EmiDAO Token'),
  ],
  [ChainId.GÖRLI]: [
    new Token(ChainId.GÖRLI, process.env.REACT_APP_ESW_ID, 18, 'ESWc', 'EmiDAO Token'),
  ],
  [ChainId.KOVAN]: [
    new Token(ChainId.KOVAN, process.env.REACT_APP_ESW_ID, 18, 'ESWc', 'EmiDAO Token'),
  ],
};
