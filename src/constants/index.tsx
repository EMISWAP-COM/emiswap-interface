...
export const networksItems: INetworkItem[] = [
  ...
  },
  {
    ...
    blockExplorerName: 'Shiden Subscan',
    analyticsUrl: 'https://emiswap.com/analytics?network=shiden',
    eswExplorerUrl: 'https://shiden.subscan.io/token/0xd2A2a353D28e4833FAFfC882f6649c9c884a7D8f',
    eswExplorerName: 'ESW Shiden Subscan',
    active: true,
    bridgeUrl: '',
  },
  {
