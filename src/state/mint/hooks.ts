import { ETHER, JSBI, Pair, Percent, Price, Token, TokenAmount } from '@uniswap/sdk';
...
export function useDerivedMintInfo(
  ...
  // amounts
  const independentAmount: TokenAmount | undefined = tryParseAmount(
    typedValue,
  ...
  const price = useMemo(() => {
    ...
    if (currencyAAmount && currencyBAmount) {
      return new Price(
        currencyAAmount.token,
        currencyBAmount.token,
        currencyAAmount.raw,
        currencyBAmount.raw,
      );
    }
