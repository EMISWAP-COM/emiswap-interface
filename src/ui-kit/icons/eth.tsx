...
export const ETHIcon: FC<IconWrapperInterface> = ({
  width = '32',
  height = '32',
  ...props
}): ReactElement => (
  <IconWrapper {...props} width={width} height={height} viewBoxSize="32">
    ...
    <rect
      ...
      height="31"
      rx="9.5"
      stroke="url(#paint0_radial_24_837)"
      stroke-opacity="0.2"
    />
    <path
    ...
    <path
      ...
      fill="#343434"
    />
    <path d="M16.0867 9.75L12.25 16.116L16.0867 18.3839V14.3721V9.75Z" fill="#8C8C8C" />
    <path
      d="M16.0863 19.1085L16.0391 19.1661V22.1104L16.0863 22.2483L19.9253 16.8418L16.0863 19.1085Z"
      fill="#3C3C3B"
    />
    <path d="M16.0867 22.2483V19.1085L12.25 16.8418L16.0867 22.2483Z" fill="#8C8C8C" />
    <path d="M16.0879 18.3838L19.9245 16.1159L16.0879 14.3721V18.3838Z" fill="#141414" />
    <path d="M12.25 16.1159L16.0866 18.3838V14.3721L12.25 16.1159Z" fill="#393939" />
    <defs>
      <radialGradient
        id="paint0_radial_24_837"
        cx="0"
        cy="0"
        r="1"
